...
- [ ] **Write `plunger/plunger.ts`** with the code above.
...
```bash
mkdir -p ~/.opencode/plugins && ln -sf /home/philip/Downloads/_project/plunger/plunger.ts ~/.opencode/plugins/plunger.ts
```
